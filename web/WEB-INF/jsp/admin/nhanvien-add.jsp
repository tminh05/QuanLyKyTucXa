...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="page-title">➕ Thêm nhân viên mới</div>
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <form action="${pageContext.request.contextPath}/admin/nhanvien/add" method="post">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" placeholder="nhanvien@ktx.com" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="info-text">Mật khẩu mặc định, nhân viên có thể đổi sau</div>
                        </div>
                        <div class="form-group">
