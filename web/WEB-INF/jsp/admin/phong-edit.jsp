...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="page-title">✏️ Sửa thông tin phòng</div>
            <a href="${pageContext.request.contextPath}/admin/logout" class="logout-btn">Đăng xuất</a>
        </div>

        <div class="form-card">
            <div class="card-header">
                <h2>🏠 Cập nhật thông tin phòng: <strong>${phong.tenPhong}</strong></h2>
            </div>
            <div class="form-body">
                ...
                <form action="${pageContext.request.contextPath}/admin/phong/edit" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="idToaNha" required>
                                <c:forEach var="tn" items="${toaNhaList}">
                                    <option value="${tn.idToaNha}" ${phong.idToaNha == tn.idToaNha ? 'selected' : ''}>
                                        ${tn.tenToaNha}
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="idLoaiPhong" required>
                                <c:forEach var="lp" items="${loaiPhongList}">
                                    <option value="${lp.idLoaiPhong}" ${phong.idLoaiPhong == lp.idLoaiPhong ? 'selected' : ''}>
                                        ${lp.tenLoai} - <fmt:formatNumber value="${lp.giaPhong}" type="number" groupingUsed="true"/> đ/tháng
                                    </option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" name="sucChua" min="1" max="10" value="${phong.sucChua}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" value="${phong.soNguoiHienTai} / ${phong.sucChua}" readonly>
                        </div>
                        <div class="form-group">
                            <label>Trạng thái</label>
                            <input type="text" value="${phong.trangThai}" readonly class="status-badge ${phong.trangThai == 'Trống' ? 'status-trong' : (phong.trangThai == 'Đầy' ? 'status-day' : 'status-dang')}">
                        </div>
                    </div>

                    <div class="form-buttons">
                        <button type="submit" class="btn-submit">💾 Cập nhật</button>
                        <a href="${pageContext.request.contextPath}/admin/phong" class="btn-cancel">❌ Hủy bỏ</a>
                    </div>
                </form>
            </div>
        </div>
