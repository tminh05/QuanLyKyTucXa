...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="page-title">➕ Thêm bài viết mới</div>
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <form action="${pageContext.request.contextPath}/admin/baiviet/add" method="post">
                    <input type="hidden" name="loaiBaiViet" value="${loaiBaiViet}">
                    ...
                    <div class="form-group">
                        <label>Tóm tắt</label>
                        <textarea name="tomTat" rows="3" placeholder="Tóm tắt nội dung bài viết..."></textarea>
                        <div class="info-text">Tóm tắt ngắn gọn nội dung, hiển thị ở trang danh sách</div>
                    </div>

                    <div class="form-group">
                        <label>Nội dung <span class="required">*</span></label>
                        <textarea name="noiDung" rows="12" placeholder="Nhập nội dung chi tiết bài viết... (có thể sử dụng thẻ HTML: &lt;p&gt;, &lt;h3&gt;, &lt;strong&gt;, &lt;mark&gt;...)" required></textarea>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="anhDaiDien" placeholder="Tên file ảnh (VD: anh-bai-viet.jpg)">
                            <div class="info-text">Đặt ảnh trong thư mục /resources/image/</div>
                        </div>
                        <div class="form-group">
                            <label>Ngày đăng</label>
                            <input type="text" value="Hôm nay (tự động)" readonly disabled>
                        </div>
                    </div>
