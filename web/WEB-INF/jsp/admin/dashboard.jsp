    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar {
            ...
            color: white; box-shadow: 2px 0 10px rgba(0,0,0,0.1); z-index: 100;
        }
        .sidebar-header {
        ...
        .sidebar-menu a {
            ...
            padding: 12px 24px; color: white; text-decoration: none;
...
.stat-card:hover { transform: translateY(-3px); box-shadow: 0 6px 20px rgba(0,0,0,0.1); }
        .stat-card-1 { background: #EBF5FB; border-left-color: #1565C0; }
        .stat-card-2 { background: #EAFAF1; border-left-color: #27AE60; }
        .stat-card-3 { background: #F5EEF8; border-left-color: #7D3C98; }
        .stat-card-4 { background: #FEF9E7; border-left-color: #F39C12; }
        ...
        .action-btn-1 { background: #1565C0; color: white; }
        .action-btn-2 { background: #e53935; color: white; }
        .action-btn-3 { background: #7B1FA2; color: white; }
        .action-btn-4 { background: #F9A825; color: white; }

        .recent-table {
            background: #EBF5FB; border-radius: 12px;
            overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);
        }
        .recent-table-header {
            padding: 16px 20px; background: #D6EAF8;
            border-bottom: 1px solid #AED6F1;
            font-weight: 700; color: #1565C0;
        }
        .recent-table table { width: 100%; border-collapse: collapse; }
        .recent-table th {
            background: #D6EAF8; padding: 14px 16px;
        ...
        .btn-view { color: #1565C0; text-decoration: none; font-weight: 600; }
...
<div class="main-content">
    ...
    <div class="quick-actions">
        ...
        <div class="action-buttons">
            <a href="${pageContext.request.contextPath}/admin/sinhvien/add" class="action-btn action-btn-1">➕ Thêm sinh viên</a>
            <a href="${pageContext.request.contextPath}/admin/phong/add" class="action-btn action-btn-2">🏠 Thêm phòng mới</a>
            <a href="${pageContext.request.contextPath}/admin/hopdong/add" class="action-btn action-btn-3">📄 Tạo hợp đồng</a>
 <a href="${pageContext.request.contextPath}/admin/nhanvien/add" class="action-btn action-btn-4">👥 Thêm nhân viên</a>
        </div>
    </div>

    <div class="recent-table">
        <div class="recent-table-header">📅 Hợp đồng sắp hết hạn (30 ngày tới)</div>
        <table>
            <thead>
                <tr>
                    <th>MSSV</th><th>Sinh viên</th><th>Phòng</th>
                    <th>Ngày kết thúc</th><th>Trạng thái</th><th></th>
                </tr>
            </thead>
            <tbody>
                ...
                <c:if test="${empty hopDongSapHetHan}">
                    <tr>
                        <td colspan="6" style="text-align:center; padding:30px; background:#EBF5FB;">
