    ...
    <div class="main-content">
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <form action="${pageContext.request.contextPath}/admin/phong/add" method="post">
                    <div class="form-row">
                        <div class="form-group">
                            <label>Tên phòng <span class="required">*</span></label>
                            <input type="text" name="tenPhong" placeholder="VD: A-101, B-202" required>
                            <div class="info-text">Ví dụ: A-101 (Tòa A - Tầng 1 - Phòng 01)</div>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="idToaNha" required>
                                ...
                                <c:forEach var="tn" items="${toaNhaList}">
                                    <option value="${tn.idToaNha}">${tn.tenToaNha}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="idLoaiPhong" required>
                                ...
                                <c:forEach var="lp" items="${loaiPhongList}">
                                    <option value="${lp.idLoaiPhong}">${lp.tenLoai} - <fmt:formatNumber value="${lp.giaPhong}" type="number" groupingUsed="true"/> đ/tháng</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Sức chứa <span class="required">*</span></label>
                            <input type="number" name="sucChua" min="1" max="10" value="4" required>
                            <div class="info-text">Số lượng sinh viên tối đa trong phòng (thường 4 hoặc 6)</div>
                        </div>
                    </div>
