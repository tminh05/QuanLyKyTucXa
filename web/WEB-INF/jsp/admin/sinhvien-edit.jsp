...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="page-title">✏️ Sửa thông tin sinh viên</div>
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <form action="${pageContext.request.contextPath}/admin/sinhvien/edit" method="post">
                    <div class="form-row">
                        <div class="form-group">
                            <label>MSSV</label>
                            <input type="text" name="mssv" value="${sinhVien.mssv}" readonly>
                            <span class="info-text">🔒 MSSV không thể thay đổi</span>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="khoa">
                                ...
                                <option value="Công nghệ Thông tin" ${sinhVien.khoa == 'Công nghệ Thông tin' ? 'selected' : ''}>Công nghệ Thông tin</option>
                                <option value="Điện tử Viễn thông" ${sinhVien.khoa == 'Điện tử Viễn thông' ? 'selected' : ''}>Điện tử Viễn thông</option>
                                <option value="Cơ khí" ${sinhVien.khoa == 'Cơ khí' ? 'selected' : ''}>Cơ khí</option>
                                <option value="Xây dựng" ${sinhVien.khoa == 'Xây dựng' ? 'selected' : ''}>Xây dựng</option>
                                <option value="Kinh tế" ${sinhVien.khoa == 'Kinh tế' ? 'selected' : ''}>Kinh tế</option>
                                <option value="Ngoại ngữ" ${sinhVien.khoa == 'Ngoại ngữ' ? 'selected' : ''}>Ngoại ngữ</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="sdt" value="${sinhVien.sdt}">
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="cccd" value="${sinhVien.cccd}">
                        </div>
                        <div class="form-group">
                            <label>Mật khẩu</label>
                            <input type="password" name="matKhau" placeholder="Để trống nếu không đổi">
                        </div>
                    </div>
